...
term syntax EthereumEff "(" {res} ":" [restype] ")" "{" SENDER "=" [s'] ";" ORIGIN "=" [o] "}" = DepEff.Eff restype [ETH v b t s, STORE, ENV c s' o] (\res => [ETH v b t s, STORE, ENV c s' o])
term syntax EthereumEff "(" {res} ":" [restype] ")" "{" SENDER "=" [s'] ";" ORIGIN "=" [o] ";" [effs] "}" = DepEff.Eff restype (ETH v b t s :: STORE :: ENV c s' o :: effs) (\res => ETH v b t s :: STORE :: ENV c s' o :: effs)
term syntax EthereumEff "(" {res} ":" [restype] ")" "{" SENDER "=" [s'] ";" ORIGIN "=" [o] ";" [ieffs] "=>" [oeffs] "}" = DepEff.Eff restype (ETH v b t s :: STORE :: ENV c s' o :: ieffs) (\res => ETH v b t s :: STORE :: ENV c s' o :: oeffs)
